...
namespace ImmucorRegistryTest
{
    ...
    public class ImmucorRegistryCommonTests : IClassFixture<IotTestFixture>
    {
        ...
        {
            var deviceId = "immucor-replicant-unauth-" + _fixture.DeviceUniqueId;
            try
            {
        ...
        {
            var deviceId = "immucor-replicant-createES-" + _fixture.DeviceUniqueId;
        ...
        {
            var deviceId = "immucor-replicant-createRSA-" + _fixture.DeviceUniqueId;
        ...
        {
            var deviceId = "immucor-replicant-unauth-es-" + _fixture.DeviceUniqueId;
        ...
        {
            var deviceId = "immucor-replicant-unauth-rsa-" + _fixture.DeviceUniqueId;
        ...
        {
            var deviceId = "immucor-replicant-config-" + _fixture.DeviceUniqueId;
        ...
        {
            var registryId = $"{_fixture.DeviceUniqueId}-notfounddevicereg";
        ...
        {
            var registryId = $"{_fixture.DeviceUniqueId}-notfoundregistry";
        ...
        //{
        //    string gatewayName = "immucor-replicant-create-gateway" + _fixture.DeviceUniqueId;
        //    try
        //    {
        ...
        //{
        //    string gatewayName = "immucor-replicant-gateway-" + _fixture.DeviceUniqueId;
        //    //Setup scenario
        //    try
        //    {
        //        var createGatewayOut = Run("createGateway", _fixture.ProjectId, _fixture.RegionId,
        ...
        //{
        //    //Setup scenario
        //    string gatewayName = "dotnet-test-gateway-" + _fixture.DeviceUniqueId;
        //    string deviceId = "dotnet-test-device-" + _fixture.DeviceUniqueId;
        //    try
        //    {
        //        var createGatewayOut = Run("createGateway", _fixture.ProjectId, _fixture.RegionId,
        //            _fixture.RegistryId, gatewayName, "test/data/rsa_cert.pem", "RS256");
